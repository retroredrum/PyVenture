inventory = []
directions = ['n', 'e', 's', 'w']
verbs = ['quit', 'inv', 'look', 'get', 'use', 'push', 'n', 'e', 's', 'w', 'd', 'u']
...
curRoomDesc = [[0, ["n", 1], "You are in a bedroom. All the windows are closed and the only exit is a door on the north wall.", {"action": "", "object":"flashlight"}],
               ...
               [6, ["s", 4, "e", 7], "You're in the garden. The grass is cut short and an old oak is the only tree. The garden extends to the south, behind the house.", {"action":"", "object":""}],
